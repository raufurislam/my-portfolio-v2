...
;
const API_BASE_URL = ("TURBOPACK compile-time value", "https://raufurislam-server.vercel.app/api/v1");
class AuthService {
...
function AuthProvider({ children }) {
    ...
    const initializeAuth = async ()=>{
        try {
            ...
            console.log("🔍 API URL:", ("TURBOPACK compile-time value", "https://raufurislam-server.vercel.app/api/v1"));
